...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/curly-hat-8af5)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/curly-hat-8af5
```

A live public deployment of this template is available at [https://curly-hat-8af5.templates.workers.dev](https://curly-hat-8af5.templates.workers.dev)
